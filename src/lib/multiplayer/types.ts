...
// Note: Currently simplified - can be extended for forts multiplayer later

export type MultiplayerGameState = any; // Generic game state type
export type MultiplayerTool = string; // Generic tool type
...
export interface TickData {
  ...
  hour: number;
  tick: number;
  stats: any; // Generic stats object
  // Only send changed tiles to minimize bandwidth
  changedTiles?: Array<{
    x: number;
    y: number;
    tile: any; // Generic tile object
  }>;
}
